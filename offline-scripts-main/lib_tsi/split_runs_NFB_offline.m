function [split_data] = split_runs_NFB_offline(excel_filename, no_trials, no_runs, dHbx_div, deoxyNFB_NFBdat)
...
for n = 1:no_runs
    ...
    split_stim_file=['stim',num2str(n),'.xlsx'];
    ...
    ind2 = ind2 + round(deoxyNFB_NFBdat.rest_durations(n, end)*dHbx_div.Fs);
