function [Hb_SDCcor, ScansQuality] = preprocessing_PMI_NFB_offline(raw, qtflag, deoxyNFB_NFBdat)
...
for sub = 1:length(dHbx_div)
    ...
    %Split the runs
    [split_data]=split_runs_NFB_offline('stim.xlsx', no_trials, no_runs, dHbx_div(sub), deoxyNFB_NFBdat(sub));
