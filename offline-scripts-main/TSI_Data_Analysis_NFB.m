...
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
%                              - BASED ON -                               %
%%    A Hitchhiker's Guide to fNIRS Data Analysis (to be published soon) %%
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
...
%This script processes NFB TSI processed data, not RAW!
...
%                               Get paths
% ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ %
aur_data_path=[DATAPATH '\Raw\NFB'];
tsi_data_path=[DATAPATH '\Matlab\NFB'];
...
exp_name = 'PMI';
n_session=length(dir(tsi_data_path))-2; % get the number of different data types
%n_session = 1;
...
for session = 1:n_session
    ...
    for sub=1:length(subs)
        ...
        load(([PATHIN_tsi '\' subname '\' tsisub(4).name]))
        ...
        [Hb_SDCcor, ScansQuality] = preprocessing_PMI_NFB_offline(raw, qtflag, deoxyNFB_NFBdat);
        ...
        [tsi_data] = tsi2nirs_NFB_offline(Hb_SDCcor, oxyNFB_NFBdat, deoxyNFB_NFBdat);
